...
| `on_shard_ready_callback` | `Callable[[int], Any]` or `Coroutine[Any, Any, Any]]` |             `None`             |                                                                      Custom callback that will be executed automatically for each shard when using AutoShardedBot. Useful for purposes such as setting a custom Bot status for each shard like "Running on shard 67 of 69", etc.                                                                      |
