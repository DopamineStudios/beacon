...
| `on_confirmation_callback`  | `Callable`  |                  `None`                   | A synchronous or asynchronous function to execute when "Confirm" is successfully pressed. Use functools.partial if it requires any extra arguments other than interaction. |
